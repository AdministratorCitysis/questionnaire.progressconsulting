       ...
       this.state = {
            questionnaire: 
            {
                ...
                questions:[
                    {
                        id:1,
                        text:"Vous êtes doué pour associer des idées et en faire la synthèse",
                        value:0,
                        categoryId:3,
                        completed:false,
                    },
                    ...
                    {
                        id:3,
                        text:"Vous essayez de garder le contrôle de vous pour ne pas biaiser l'exercice créatif",
                        value:0,
                        categoryId:4,
                        completed:false,
                    },
                    {
                        id:4,
                        text:"Le secret d'une bonne session créative réside souvent dans la qualité de l'écoute",
                        value:0,
                        categoryId:1,
                        completed:false,
                    },
                    {
                        id:5,
                        text:"Vous êtes épaté par les créateurs et les artistes",
                        value:0,
                        categoryId:3,
                        completed:false,
                    },
                    {
                        id:6,
                        text:"Vous pensez que : être créatif c'est générer beaucoup d'idées pour se préparer aux différentes éventualités",
                        value:0,
                        categoryId:2,
                        completed:false,
                    },
                    ...
                    {
                        id:9,
                        text:"Vous aimez voir le problème de manière globale et ne pas vous perdre dans les détails",
                        value:0,
                        categoryId:3,
                        completed:false,
                    },
                    {
                        id:10,
                        text:"Vous aimez réfléchir avant d'agir",
                        value:0,
                        categoryId:2,
                        completed:false,
                    },
                    ...
                    {
                        id:16,
                        text:"Le plaisir d'échanger ensemble passe parfois avant le résultat des idées générées",
                        value:0,
                        categoryId:1,
                        completed:false,
                    },
                    {
                        id:17,
                        text:"Vous aimez collecter vos sources d'inspiration partout et êtes curieux de tout",
                        value:0,
                        categoryId:3,
                        completed:false,
                    },
                    ...
                    {
                        id:19,
                        text:"Vous êtes curieux de connaître les différentes étapes du processus créatif",
                        value:0,
                        categoryId:4,
                        completed:false,
                    },
                    {
                        id:20,
                        text:"C'est bon de temps en temps d'avoir des idées utopistes",
                        value:0,
                        categoryId:1,
                        completed:false,
                    },
                    {
                        id:21,
                        text:"Une session créative réussie ressemble quasiment à un jeu",
                        value:0,
                        categoryId:3,
                        completed:false,
                    },
                    ...
                    {
                        id:25,
                        text:"Vous appréciez les personalités audacieuses",
                        value:0,
                        categoryId:3,
                        completed:false,
                    },
                    {
                        id:26,
                        text:'Vous aimez tenir des raisonnement cohérents',
                        value:0,
                        categoryId:2,
                        completed:false,
                    },
                    {
                        id:27,
                        text:'Vous aimez les techniques créatives reconnues et éprouvées',
                        value:0,
                        categoryId:4,
                        completed:false,
                    },
                    {
                        id:28,
                        text:"Être créatif, c'est souvent observer et voir ce que les autres ne voient pas ",
                        value:0,
                        categoryId:1,
                        completed:false,
                    },
                    ...
                    {
                        id:38,
                        text:"Découper un problème en plusieurs séquences vous aider à générer des solutions",
                        value:0,
                        categoryId:2,
                        completed:false,
                    },
